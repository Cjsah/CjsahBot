...
public class ArgumentCommandNode<S, T> extends CommandNode<S> {
    ...
    public ArgumentCommandNode(String name, Argument<T> argument, @Nullable String pluginId, @Nullable Command<S> command, Predicate<S> requirement) {
    ...
    protected ArgumentBuilder<S, ?> builderFactory() {
        return RequiredArgumentBuilder.argument(this.name, this.argument);
    }
