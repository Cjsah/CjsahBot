...
public final class Event {
    ...
    public static <T extends IEvent> void subscribe(Plugin plugin, Class<T> clazz, Consumer<T> handler) {
    ...
    public static <T extends IEvent> void unsubscribe(Class<T> event) {
        Plugin plugin = PluginContext.getCurrentPlugin();
    ...
    record EventNode<T extends IEvent>(Plugin plugin, Class<T> event, Consumer<T> handler) {}
