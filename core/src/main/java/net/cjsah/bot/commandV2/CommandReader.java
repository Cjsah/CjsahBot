...
public final class CommandReader {
    ...
    public CommandReader(String cmd) {
        this.cmd = cmd;
        this.cursor = 1;
    ...
    public int getRemainLength() {
        return this.cmd.length() - this.cursor;
    }

    public String getRead() {
        return this.cmd.substring(0, this.cursor);
    }

    public String getRemaining() {
        return this.cmd.substring(this.cursor);
    }
    ...
    public boolean canRead(int length) {
        return this.cursor + length <= cmd.length();
    }
    ...
    public char peek(int offset) {
        return this.cmd.charAt(this.cursor + offset);
    }
    ...
    public int readInt() throws CommandException {
        ...
        String number = this.cmd.substring(start, this.cursor);
        if (number.isEmpty()) {
